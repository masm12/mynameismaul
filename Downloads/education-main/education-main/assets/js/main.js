(function ($) {
	...
	////////////////////////////////////////////////////
	// 13. Swiper Js	
	const sliderswiper = new Swiper('.ed-slider-active', {
		// Optional parameters
		speed:1500,
		loop: true,
		slidesPerView: 1,
...
$('#ship-box').on('click', function () {
	...
	// for header
	if ($("#ed-header-4-lang").length > 0) {
		window.addEventListener('click', function (e) {

			if (document.getElementById('ed-header-4-lang').contains(e.target)) {
				$(".ed-header-4-lang").toggleClass("open");
			}
			else {
				$(".ed-header-4-lang").removeClass("open");
			}
		});
	}	
